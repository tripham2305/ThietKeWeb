!function(t, e, i, s) {
    ...
    n.prototype.registerEventHandlers = function() {
        t.support.transition && this.$stage.on(t.support.transition.end + ".btq.core", t.proxy(this.onTransitionEnd, this)),
        ...
        this.settings.touchDrag && (this.$stage.on("touchstart.btq.core", t.proxy(this.onDragStart, this)),
    ...
    n.prototype.onDragStart = function(e) {
        ...
        t(i).one("mousemove.btq.core touchmove.btq.core", t.proxy(function(e) {
    ...
    n.prototype.onDragEnd = function(e) {
        ...
        (Math.abs(s.x) > 3 || (new Date).getTime() - this._drag.time > 300) && this._drag.target.one("click.btq.core", function() {
            return !1
        })),
    ...
    n.prototype.closest = function(e, i) {
        ...
        return this.settings.freeDrag || t.each(r, t.proxy(function(t, a) {
            return "left" === i && e > a - n && a + n > e ? s = t : "right" === i && e > a - o - n && a - o + n > e ? s = t + 1 : this.op(e, "<", a) && this.op(e, ">", r[t + 1] || a - o) && (s = "left" === i ? t + 1 : t),
            -1 === s
        }, this)),
    ...
    n.prototype.maximum = function(t) {
        ...
        if (i.loop)
            ...
            for (; s - o > 1; )
                Math.abs(this._coordinates[e = s + o >> 1]) < n ? o = e : s = e;
        else
    ...
    n.prototype.add = function(e, i) {
        ...
        this._items.push(e),
        this._mergers.push(1 * e.find("[data-merge]").attr("data-merge") || 1)) : (this._items[i].before(e),
...
function(t, e, i, s) {
    ...
    n.prototype.load = function(i) {
        ...
        o.each(t.proxy(function(i, s) {
            ...
            o.is("img") ? (o.one("load.btq.lazy", t.proxy(function() {
                o.css("opacity", 1),
            ...
            o.parent().parent().addClass("done")) : o.is("source") ? (o.one("load.btq.lazy", t.proxy(function() {
                this._core.trigger("loaded", {
                    element: o,
                    url: r
                }, "lazy")
            }, this)).attr("srcset", r),
            o.parent().parent().addClass("done")) : (n = new Image,
...
function(t) {
    ...
    ,
    t.fn.BTQSlider.Constructor.Plugins.AutoHeight = e
}(window.Zepto || window.jQuery, window, document),
function(t, e, i) {
    var s = function(e) {
        this._core = e,
        ...
        this._core.$element.on(this._handlers),
        this._core.$element.on("click.btq.video", ".slide-video-play-icon", t.proxy(function(t) {
            this.play(t)
        }, this))
    };
    s.Defaults = {
    ...
    s.prototype.thumbnail = function(e, i) {
        var s, n, o, r = i.width && i.height ? 'style="width:' + i.width + "px;height:" + i.height + 'px;"' : "", a = e.find("img"), h = "src", l = "", c = this._core.settings, d = function(t) {
            n = '<div class="slide-video-play-icon"></div>',
            s = c.lazyLoad ? '<div class="slide-video-tn ' + l + '" ' + h + '="' + t + '"></div>' : '<div class="slide-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>',
            e.after(s),
            e.after(n)
        };
        return e.wrap('<div class="slide-video-wrapper"' + r + "></div>"),
    ...
    s.prototype.play = function(e) {
        ...
        "youtube" === o.type ? i = '<iframe width="' + r + '" height="' + a + '" src="//www.youtube.com/embed/' + o.id + "?autoplay=1&v=" + o.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === o.type ? i = '<iframe src="//player.vimeo.com/video/' + o.id + '?autoplay=1" width="' + r + '" height="' + a + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>' : "vzaar" === o.type && (i = '<iframe frameborder="0"height="' + a + '"width="' + r + '" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/' + o.id + '/player?autoplay=true"></iframe>'),
        t('<div class="slide-video-frame">' + i + "</div>").insertAfter(n.find(".slide-video")),
        this._playing = n.addClass("slide-video-playing"))
    }
    ,
...
function(t, e, i, s) {
    ...
    n.prototype.swap = function() {
        if (1 === this.core.settings.items && t.support.animation && t.support.transition) {
            ...
            s.one(t.support.animation.end, i).css({
                left: e + "px"
            }).addClass("animated animated-out").addClass(r)),
            o && n.one(t.support.animation.end, i).addClass("animated animated-in").addClass(o))
        }
    }
    ,
    n.prototype.clear = function(e) {
        t(e.target).css({
            left: ""
        }).removeClass("animated animated-out animated-in").removeClass(this.core.settings.animateIn).removeClass(this.core.settings.animateOut),
...
function(t) {
    ...
    e.prototype.draw = function() {
        ...
        1 == i.dotNum && 0 !== e && this._controls.$absolute.children().each(function(e, i) {
            t(i).children().addClass("dot-number"),
            t(this).children().text(e + 1)
        }),
        0 == i.dotNum && 0 !== e && (t(".dot-number").empty(),
        t("div .dot-number").removeClass("dot-number")),
...
function(t, e, i, s) {
    ...
    var n = function(i) {
        ...
        this._core.options = t.extend({}, n.Defaults, this._core.options),
        this.$element.on(this._handlers),
        t(e).on("hashchange.btq.navigation", t.proxy(function() {
